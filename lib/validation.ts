import { LETTER_REGEX, SPECIAL_CHAR_REGEX, ERRORS_PASSWORD } from "@/constants/errors";
...
export const Validation = {
    ...
    validatePasswordMatch(password: string, repeatNewPassword: string): string | null {
