  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="mt-3 after:border-border text-gray-400 relative text-center text-xs font-medium after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
