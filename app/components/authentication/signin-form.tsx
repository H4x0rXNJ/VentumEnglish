...
import {authSignIn} from "@/app/components/authentication/sign-in-request";
import "@/app/sign-up/alert-animations.css"
...
export function LoginForm({
    ...
    return (
        <form onSubmit={handleSubmit} className={cn(" flex flex-col gap-6", className)} {...props}>
            ...
            <Button type={"button"} onClick={() => signIn("github", {callbackUrl: "/dashboard"})} variant="outline"
            ...
            <div
                className="after:border-border text-gray-400 relative text-center text-xs font-medium after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
                    <span
                        className="bg-background text-muted-foreground relative z-10 px-2">Or continue with email</span>
            </div>
