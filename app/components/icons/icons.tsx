...
export function GitHubIcon() {
    return (
        <svg viewBox="0 0 24 24">
            <path
                d="M12 0.2975C5.37 0.2975 0 5.67 0 12.3c0 5.29 3.438 9.78 8.205 11.37.6.113.82-.262.82-.582 0-.288-.012-1.244-.018-2.447-3.338.724-4.042-1.61-4.042-1.61-.546-1.388-1.332-1.757-1.332-1.757-1.09-.744.083-.73.083-.73 1.204.086 1.838 1.24 1.838 1.24 1.07 1.83 2.807 1.3 3.492.996.108-.775.418-1.3.76-1.6-2.665-.3-5.467-1.33-5.467-5.93 0-1.31.465-2.38 1.235-3.22-.124-.303-.535-1.523.118-3.176 0 0 1.008-.322 3.3 1.23a11.5 11.5 0 013.003-.4 11.5 11.5 0 013.003.4c2.29-1.552 3.295-1.23 3.295-1.23.655 1.653.244 2.873.12 3.176.77.84 1.23 1.91 1.23 3.22 0 4.61-2.807 5.625-5.48 5.92.43.37.815 1.096.815 2.21 0 1.596-.015 2.88-.015 3.27 0 .32.215.694.825.576C20.565 22.078 24 17.59 24 12.3c0-6.63-5.373-12.003-12-12.003z"
                fill="#181717"/>
        </svg>
    );
}
